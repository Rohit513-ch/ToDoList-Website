  ...
  return (
    <div className="form-container">
      ...
      <form className="form" onSubmit={handleLogin}>
        ...
        <button type="submit" className="form-btn" disabled={loading} suppressHydrationWarning>
      ...
      <div className="buttons-container">
        <button type="button" className="apple-login-button" disabled={loading} suppressHydrationWarning>
        ...
        <button type="button" className="google-login-button" onClick={signInWithGoogle} disabled={loading} suppressHydrationWarning>
