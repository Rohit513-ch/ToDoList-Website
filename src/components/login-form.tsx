  ...
  return (
    <div className="form-container">
      ...
      <div className="buttons-container">
        <button className="apple-login-button" disabled={loading} suppressHydrationWarning>
        ...
        <button className="google-login-button" onClick={signInWithGoogle} disabled={loading} suppressHydrationWarning>
