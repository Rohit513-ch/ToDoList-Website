...
const AppleSvgIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" {...props}>
    <title>Apple</title>
    <path d="M12.152 6.896c-.948 0-1.855.39-2.527 1.048-.672.658-.994 1.525-.994 2.457 0 1.055.4 2.035 1.22 2.655.81.6 1.803.88 2.75.88.98 0 1.93-.38 2.6-.98.67-.6 1.1-1.56 1.1-2.58s-.46-1.96-1.13-2.58c-.67-.62-1.594-.95-2.584-.95Zm.03 8.35c-2.11 0-4.14-.9-5.5-2.48-.36.56-.56 1.2-.56 1.87 0 1.95 1.58 3.53 3.53 3.53 1.06 0 2.03-.46 2.7-1.23.64.73 1.55 1.18 2.56 1.18 2.05 0 3.7-1.65 3.7-3.7 0-1.74-1.2-3.2-2.8-3.6.1-2.1-1.5-4-3.6-4-1.4 0-2.6.77-3.23 1.86-.3-.1-.6-.1-.9-.1Z"/>
  </svg>
);
